...
Also code referenced from: https://gist.github.com/ojedatony1616/e605222e4442da2db9e5d670d0f797b3
'''
###################################################################################################
...
extract_candidate_chunks(text)   # Test
...
extract_candidate_words(text)    # Test   
...
# DY testing code find a way to print results    
